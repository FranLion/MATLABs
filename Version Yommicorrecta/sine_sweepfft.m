function sine_sweepfft(f1,f2,T,ns) % f1= Frecuencia 1; f2= Frecuencia 2; T= Tiempo en segundos; ns= nombre de archivo;
...
try 
    ...
    T= T+1; % aca se agrega 1 segundo antes de la grabacion, solicitado por el profesor
